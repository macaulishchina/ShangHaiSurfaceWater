...
import com.sinoyd.frame.adapter.Frm_Fragment_Adapter;
...
public class ShowCase_ViewPageDemo extends SinoBaseActivity implements ViewPager.OnPageChangeListener{
    ...
    View CurrentView;
    View[] lls = new View[3];
    private Frm_Fragment_Adapter mPagerAdapter;
    ...
    void initView(){
        ...
        mPagerAdapter = new Frm_Fragment_Adapter(getFragmentManager(), frms);
