...
interface ColorfulYAxisRendererDataSourcebar {
    fun numberOfSegements(renderer: ColorfulYAxisRendererbar): Int
    fun renderercolor(renderer: ColorfulYAxisRendererbar, colorForSegementAt: Int): Int
    fun renderervalue(renderer: ColorfulYAxisRendererbar, colorForSegementAt: Int): Float
}


open class ColorfulYAxisRendererbar(chart: BarLineChartBase<BarData>, dataSource: ColorfulYAxisRendererDataSourcebar?) : YAxisRenderer(chart.viewPortHandler, chart.axisLeft, chart.getTransformer(YAxis.AxisDependency.LEFT)) {

    var dataSource: ColorfulYAxisRendererDataSourcebar? = null
