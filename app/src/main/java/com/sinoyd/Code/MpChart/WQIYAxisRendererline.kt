...
class WQIYAxisRendererline(chart: LineChart) : ColorfulYAxisRendererline(chart, dataSource = null), ColorfulYAxisRendererDataSourceline {
    ...
    override fun numberOfSegements(renderer: ColorfulYAxisRendererline): Int = 6

    override fun renderercolor(renderer: ColorfulYAxisRendererline, index: Int): Int {
        return colorsline[index]
    }

    override fun renderervalue(renderer: ColorfulYAxisRendererline, index: Int): Float {
