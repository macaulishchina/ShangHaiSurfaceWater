...
interface TrendModel {
    fun getTrend(beginTime: String, endTime: String, id: String, tag: String, listener: HttpListener)
}


class TrendImpl : TrendModel {
    override fun getTrend(beginTime: String, endTime: String, id: String, tag: String, listener: HttpListener) {
        val params = RequestParams(Networkrequestaddress.Gettrend + "/$id/trend?beginTime=$beginTime&endTime=$endTime")
