...
interface CategoriesModel {
    fun getCategories(tag: String, listener: HttpListener)
}


class CategoriesImpl : CategoriesModel {
    override fun getCategories(tag: String, listener: HttpListener) {
        val params = RequestParams(Networkrequestaddress.Getcategories)
