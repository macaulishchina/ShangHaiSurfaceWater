...
interface AlarmInfoModel {
    fun getAlarmInfo(beginTime: String, endTime: String, pageNo: Int, pageSize: Int, tag: String, listener: HttpListener)
}


class AlarmInfoImpl : AlarmInfoModel {
    override fun getAlarmInfo(beginTime: String, endTime: String, pageNo: Int, pageSize: Int, tag: String, listener: HttpListener) {
        val params = RequestParams(Networkrequestaddress.GetAlarmInfo + "?" +
                "beginTime=$beginTime&" +
                "endTime=$endTime&" +
                "pageNo=$pageNo&" +
                "pageSize=$pageSize")
