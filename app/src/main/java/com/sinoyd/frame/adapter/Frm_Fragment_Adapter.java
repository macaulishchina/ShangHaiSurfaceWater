 ...
 */
public class Frm_Fragment_Adapter extends FragmentPagerAdapter {
     ...
     * @param frms
     */
    public Frm_Fragment_Adapter(FragmentManager fm, Fragment[] frms) {
        super(fm);
        this.frms = frms;
        this.params = null;
    }
     ...
     * @param params
     */
    public Frm_Fragment_Adapter(FragmentManager fm, Fragment[] frms, List<FrmFragmentParamModel> params) {
        super(fm);
        this.frms = frms;
        this.params = params;
    }
